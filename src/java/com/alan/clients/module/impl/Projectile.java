package com.alan.clients.module.impl;
...
@ModuleInfo(name = "module.render.projectile.name", category = Category.RENDER,description = "Projectile", autoEnabled = true)
public class Projectile extends Module {
    float yaw;
    float pitch;
    @EventLink()
    public final Listener<PreMotionEvent> onPreMotionEvent = e -> {
        this.yaw = e.getYaw();
    ...
    public final Listener<Render3DEvent> onRender3D = event -> {
        ...
        if (Projectile.mc.thePlayer.getCurrentEquippedItem() != null) {
            ...
            RenderUtil.color(new Color(206, 89, 255, 255));
            ...
            if (landingPosition != null) {
                ...
                if (side == 1 && heldItem instanceof ItemEnderPearl) {
                    RenderUtil.color(new Color(255, 248, 0, 255));
                }
                else if (side == 2) {
