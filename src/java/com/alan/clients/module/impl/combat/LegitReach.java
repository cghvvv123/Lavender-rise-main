...
public final class LegitReach extends Module {
    ...
    public final Listener<PreUpdateEvent> onPreUpdate = event -> {
        ...
        if (targetEntity == null || InstanceAccess.mc.thePlayer.isSwingInProgress) {
            return;
        }
        ...
        while ((targetEntity.getDistanceToEntity(InstanceAccess.mc.thePlayer) > 3 ||
                realTargetPosition.distanceTo(new Vec3(InstanceAccess.mc.thePlayer.posX, InstanceAccess.mc.thePlayer.posY, InstanceAccess.mc.thePlayer.posZ)) > 6) &&
    ...
    public final Listener<Render3DEvent> onRender3D = event -> {
        ...
        if (realTargetPosition.squareDistanceTo(new Vec3(targetEntity.posX, targetEntity.posY, targetEntity.posZ)) > 0.1) {
            ...
            RenderUtil.drawBoundingBox(InstanceAccess.mc.thePlayer.getEntityBoundingBox().offset(-InstanceAccess.mc.thePlayer.posX, -InstanceAccess.mc.thePlayer.posY, -InstanceAccess.mc.thePlayer.posZ).
