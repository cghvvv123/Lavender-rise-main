...
public class SafeWalk extends Module {
    ...
    @EventLink()
    public final Listener<PreUpdateEvent> onPreUpdate = event -> InstanceAccess.mc.thePlayer.safeWalk = InstanceAccess.mc.thePlayer.onGround && (!InstanceAccess.mc.gameSettings.keyBindForward.isKeyDown() || !backwardsOnly.getValue()) &&
