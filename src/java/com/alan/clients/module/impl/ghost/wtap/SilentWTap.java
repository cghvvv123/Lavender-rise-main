    ...
    public final Listener<PreMotionEvent> onPreMotionEvent = event -> {
        ...
        switch (ticks) {
            case 1:
                ...
                if (sprinting) {
                    PacketUtil.send(new C0BPacketEntityAction(InstanceAccess.mc.thePlayer, C0BPacketEntityAction.Action.STOP_SPRINTING));
                } else {
                    PacketUtil.send(new C0BPacketEntityAction(InstanceAccess.mc.thePlayer, C0BPacketEntityAction.Action.START_SPRINTING));
                }
                break;
