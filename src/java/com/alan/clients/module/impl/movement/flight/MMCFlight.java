    ...
    public final Listener<PreMotionEvent> onPreMotionEvent = event -> {
        ...
        if (ticks == 1) {
            if (PlayerUtil.blockRelativeToPlayer(0, -2.5, 0).isFullBlock()) {
                InstanceAccess.mc.timer.timerSpeed = 0.1F;
                ...
                PacketUtil.send(new C03PacketPlayer.C04PacketPlayerPosition(InstanceAccess.mc.thePlayer.posX, MoveUtil.roundToGround(InstanceAccess.mc.thePlayer.posY - (2.5 - (Math.random() / 100))), InstanceAccess.mc.thePlayer.posZ, false));
