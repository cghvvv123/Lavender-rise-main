...
public class UnKnownAC extends Mode<Flight> {
    ...
    public final Listener<PreUpdateEvent> onPreUpdate = event -> {
        ...
        RotationComponent.setRotations(new Vector2f(InstanceAccess.mc.thePlayer.rotationYaw, 90), 10, MovementFix.TRADITIONAL);
    ...
    public final Listener<PreMotionEvent> onPreMotionEvent = event -> {
        ...
        InstanceAccess.mc.timer.timerSpeed = Math.max(1, speed.getValue().floatValue() - ticks / 50f);
