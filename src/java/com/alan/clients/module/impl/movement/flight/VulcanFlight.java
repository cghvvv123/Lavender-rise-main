...
public class VulcanFlight extends Mode<Flight> {
    ...
    public void onEnable() {
        ticks = 0;
        PacketUtil.send(new C03PacketPlayer.C06PacketPlayerPosLook(InstanceAccess.mc.thePlayer.posX, InstanceAccess.mc.thePlayer.posY - 2, InstanceAccess.mc.thePlayer.posZ,
                InstanceAccess.mc.thePlayer.rotationYaw, InstanceAccess.mc.thePlayer.rotationPitch, false));
    }
