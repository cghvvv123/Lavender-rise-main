...
public class WatchdogInventoryMove extends Mode<InventoryMove> {
    ...
    public final Listener<PreUpdateEvent> onPreUpdate = event -> {
        ...
        if (InstanceAccess.mc.currentScreen instanceof GuiChat || InstanceAccess.mc.currentScreen == this.getStandardClickGUI() || InstanceAccess.mc.currentScreen instanceof GuiInventory) {
            return;
        }
