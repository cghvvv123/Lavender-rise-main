...
public class BlocksMCNoSlow extends Mode<NoSlow> {
    ...
    public final Listener<PreMotionEvent> onPreMotion = event -> {
        if (InstanceAccess.mc.thePlayer.getHeldItem() == null || !MoveUtil.isMoving() || !InstanceAccess.mc.thePlayer.isUsingItem()) return;

        if (InstanceAccess.mc.thePlayer.getHeldItem().getItem() instanceof ItemSword) {
            ...
            PacketUtil.send(new C09PacketHeldItemChange(InstanceAccess.mc.thePlayer.inventory.currentItem));
        }
    };
}
