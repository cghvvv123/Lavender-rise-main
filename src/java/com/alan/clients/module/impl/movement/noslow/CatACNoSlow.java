...
public class CatACNoSlow extends Mode<NoSlow> {
    ...
    public final Listener<PreMotionEvent> onPreMotion = event -> {
        if (InstanceAccess.mc.thePlayer.getHeldItem() != null && InstanceAccess.mc.thePlayer.getHeldItem().getItem() instanceof ItemSword && InstanceAccess.mc.thePlayer.isUsingItem())
    ...
    public final Listener<SlowDownEvent> onSlowDown = event -> {
        if (InstanceAccess.mc.thePlayer.getHeldItem() != null && InstanceAccess.mc.thePlayer.getHeldItem().getItem() instanceof ItemSword && InstanceAccess.mc.thePlayer.isUsingItem()) event.setCancelled();
    };
}
