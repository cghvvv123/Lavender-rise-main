        ...
        if (MoveUtil.isMoving()) {
            switch (InstanceAccess.mc.thePlayer.offGroundTicks) {
                case 0:
                    ...
                    float motion = InstanceAccess.mc.thePlayer.isCollidedHorizontally ? 0.42F : jumpMotion == 0.4f ? jumpMotion : 0.42f;
                    InstanceAccess.mc.thePlayer.motionY = MoveUtil.jumpBoostMotion(motion);
