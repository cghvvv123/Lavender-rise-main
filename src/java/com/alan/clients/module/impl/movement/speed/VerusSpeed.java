    ...
    public final Listener<PreMotionEvent> onPreMotionEvent = event -> {
        ...
        switch (mode.getValue().getName()) {
            case "Hop": {
                ...
                if (!(InstanceAccess.mc.thePlayer.moveForward > 0)) {
            ...
            case "Fast": {
                ...
                if (InstanceAccess.mc.thePlayer.onGround) {
                    ...
                    InstanceAccess.mc.timer.timerSpeed = 2.1F;
                    ticks = 0;
                } else {
                    if (ticks >= 10) {
                        bool = true;
                    ...
                    InstanceAccess.mc.thePlayer.motionY = 0F;
                    InstanceAccess.mc.timer.timerSpeed = 0.9F;
