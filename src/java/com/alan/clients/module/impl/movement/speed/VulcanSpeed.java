    ...
    public final Listener<PostStrafeEvent> onPostStrafe = event -> {
        switch (mode.getValue().getName()) {
            case "Use Disabler":
                ...
                boolean nextGround = InstanceAccess.mc.thePlayer.offGroundTicks == 11;
                boolean ground = InstanceAccess.mc.thePlayer.onGround;
        ...
        switch (mode.getValue().getName()) {
            case "BHop":
                switch (InstanceAccess.mc.thePlayer.offGroundTicks) {
                    ...
                    case 9:
                        if (!(PlayerUtil.blockRelativeToPlayer(0, InstanceAccess.mc.thePlayer.motionY,
            ...
            case "Funny":
                ...
                if (!BadPacketsComponent.bad(false, true, false, false, false) && lastRightClick < InstanceAccess.mc.thePlayer.ticksExisted) {
                    lastRightClick = InstanceAccess.mc.thePlayer.ticksExisted + 2;
                ...
                switch (InstanceAccess.mc.thePlayer.offGroundTicks) {
                    case 0:
                        ...
                        InstanceAccess.mc.thePlayer.motionY = 0.2f;
                        break;

                    case 1:
                        InstanceAccess.mc.thePlayer.motionY = MoveUtil.HEAD_HITTER_MOTION;
