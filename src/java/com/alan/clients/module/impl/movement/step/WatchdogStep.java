...
public class WatchdogStep extends Mode<Step> {
    ...
    public final Listener<StepEvent> onStep = event -> {
        ...
        for (final double d : values) {
            PacketUtil.send(new C03PacketPlayer.C04PacketPlayerPosition(InstanceAccess.mc.thePlayer.posX, InstanceAccess.mc.thePlayer.posY + d, InstanceAccess.mc.thePlayer.posZ, false));
        }
    };
