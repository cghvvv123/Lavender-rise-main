    ...
    public final Listener<PacketSendEvent> onPacketSend = event -> {
        ...
        if (p instanceof C03PacketPlayer) {
            ...
            if (!PlayerUtil.isBlockUnder()) {
                ...
                if (position != null && InstanceAccess.mc.thePlayer.fallDistance > distance.getValue().floatValue()) {
                ...
                if (PlayerUtil.isBlockUnder(0.1) || InstanceAccess.mc.thePlayer.onGround) {
