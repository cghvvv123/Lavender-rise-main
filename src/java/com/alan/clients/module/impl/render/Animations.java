...
Animations extends Module {
    ...
    public final Listener<RenderItemEvent> onRenderItem = event -> {
        ...
        final ItemRenderer itemRenderer = InstanceAccess.mc.getItemRenderer();
            ...
            switch (swingAnimation.getValue().getName()) {
                ...
                case "1.9+": {
                    ...
                    GlStateManager.translate(0, -((swing - 1) -
                            (swing == 0 ? 0 : InstanceAccess.mc.timer.renderPartialTicks)) / 5f, 0);
                    break;
                }
    ...
    public final Listener<SwingAnimationEvent> onSwingAnimation = event -> {
        ...
        swingAnimationEnd *= (int) ((-swingSpeed.getValue().floatValue() / 100f) + 1f);
    ...
    public final Listener<AttackEvent> onAttack = event -> {
        ...
        if (swingAnimation.getValue().getName().equals("1.9+")) {
            final ItemStack currentItem = InstanceAccess.mc.thePlayer.getCurrentEquippedItem();

            if (currentItem != null && target != null) {
                currentItem.setRepairCost((int) (Math.random() * 100));

                PacketUtil.receiveNoEvent(new S2FPacketSetSlot(0, 36 + InstanceAccess.mc.thePlayer.inventory.currentItem, currentItem));
            }
        }
    };
...
//            mc.entityRenderer.itemRenderer.resetEquippedProgress2();
        ...
        if (InstanceAccess.mc.thePlayer.swingProgressInt == 1) {
            swing = 9;
        } else {
