...
public final class CPSCounter extends Module {
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        scale.x = titleWidth + InstanceAccess.nunitoNormal.width(cpsString);
        ...
        InstanceAccess.NORMAL_POST_RENDER_RUNNABLES.add(() -> {
            ...
            InstanceAccess.nunitoNormal.drawStringWithShadow(cpsString, textX + titleWidth, textY, Color.WHITE.getRGB());
        });
