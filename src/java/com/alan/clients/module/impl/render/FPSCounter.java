...
public final class FPSCounter extends Module {
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        scale.x = titleWidth + InstanceAccess.nunitoNormal.width(fpsString);
        ...
        InstanceAccess.NORMAL_POST_RENDER_RUNNABLES.add(() -> {
            ...
            InstanceAccess.nunitoNormal.drawStringWithShadow(fpsString, textX + titleWidth, textY, Color.WHITE.getRGB());
        });
        InstanceAccess.NORMAL_BLUR_RUNNABLES.add(() -> RenderUtil.roundedRectangle(position.x, position.y + 0.5, scale.x + 6, scale.y - 1, getTheme().getRound(), Color.BLACK));
