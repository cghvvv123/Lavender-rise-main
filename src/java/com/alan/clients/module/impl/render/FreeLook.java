...
public final class FreeLook extends Module {
    ...
    protected void onEnable() {
        previousPerspective = InstanceAccess.mc.gameSettings.thirdPersonView;
        originalYaw = lastYaw = InstanceAccess.mc.thePlayer.rotationYaw;
        originalPitch = lastPitch = InstanceAccess.mc.thePlayer.rotationPitch;
    ...
    protected void onDisable() {
        InstanceAccess.mc.thePlayer.rotationYaw = originalYaw;
        InstanceAccess.mc.thePlayer.rotationPitch = originalPitch;
        InstanceAccess.mc.gameSettings.thirdPersonView = previousPerspective;
    }
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        InstanceAccess.mc.gameSettings.thirdPersonView = 1;
    };
