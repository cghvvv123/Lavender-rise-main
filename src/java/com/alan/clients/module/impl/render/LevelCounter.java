...
import java.awt.*;
@ModuleInfo(name = "module.render.levelcounter.name",category = Category.RENDER,description = "CNM")
public class LevelCounter extends Module {
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        final String titleString = showTitle.getValue() ? "Level " : "";
        final String levelString = mc.thePlayer.experienceLevel + "";

        final float titleWidth = nunitoNormal.width(titleString);
        scale.x = titleWidth + nunitoNormal.width(levelString);
        ...
        NORMAL_POST_RENDER_RUNNABLES.add(() -> {
            ...
            nunitoNormal.drawStringWithShadow(levelString, textX + titleWidth, textY, Color.WHITE.getRGB());
        });
