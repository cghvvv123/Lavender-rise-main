...
public final class GammaFullBright extends Mode<FullBright> {
    ...
    public final Listener<TickEvent> onTick = event -> {
        InstanceAccess.mc.gameSettings.gammaSetting = 100.0F;
    };

    @Override
    public void onEnable() {
        oldGamma = InstanceAccess.mc.gameSettings.gammaSetting;
    }

    @Override
    public void onDisable() {
        InstanceAccess.mc.gameSettings.gammaSetting = oldGamma;
    }
}
