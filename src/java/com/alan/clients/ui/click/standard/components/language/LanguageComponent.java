...
public class LanguageComponent implements InstanceAccess {
    ...
    public void draw(double y) {
        ...
        FontManager.arial20.drawString(this.englishName, (float) (position.getX() + sidebar + 18), (float) (position.getY() + y + 9),
        ...
        FontManager.arial18.drawString(this.localName, (float) (position.getX() + sidebar + 18),
                (float) (position.getY() + y + 24), ColorUtil.withAlpha(getStandardClickGUI().getFontColor(), 100).hashCode());

        // Draw flag
        RenderUtil.image(new ResourceLocation("lavender/icons/language/" + locale.getFile() + ".png"),
                position.getX() + sidebar + FontManager.arial20.getStringWidth(this.englishName) + 25, position.getY() + y + 5, 15, 15);
