...
public class BooleanValueComponent extends ValueComponent {
    ...
    public void draw(final Vector2d position, final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final double positionX = this.position.x + FontManager.arial16.getStringWidth(this.value.getName()) + 3;
    ...
    public void bloom() {
        ...
        final double positionX = this.position.x + FontManager.arial16.getStringWidth(this.value.getName()) + 2;
