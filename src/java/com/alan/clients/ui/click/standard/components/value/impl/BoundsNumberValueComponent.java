...
public class BoundsNumberValueComponent extends ValueComponent {
    ...
    public void draw(final Vector2d position, final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final float valueWidth = FontManager.arial16.getStringWidth(this.value.getName()) + 7;
        ...
        // Draws value
        FontManager.arial16.drawString(value.replace(".0", ""), (float) (this.position.x + valueWidth + 105), (float) this.position.y, this.getStandardClickGUI().fontDarkColor.hashCode());
