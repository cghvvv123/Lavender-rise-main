...
public class ListValueComponent extends ValueComponent {
    ...
    public void draw(final Vector2d position, final int mouseX, final int mouseY, final float partialTicks) {
        ...
        FontManager.arial16.drawString(prefix, (float) this.position.x, (float) this.position.y, this.getStandardClickGUI().fontDarkColor.hashCode());
        FontManager.arial16.drawString(listValue.getValue().toString(), (float) (this.position.x + FontManager.arial16.getStringWidth(prefix) + 2), (float) this.position.y, this.getStandardClickGUI().fontDarkColor.hashCode());
    }
