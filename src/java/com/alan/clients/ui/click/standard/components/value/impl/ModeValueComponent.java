...
public class ModeValueComponent extends ValueComponent {
    ...
    public void draw(final Vector2d position, final int mouseX, final int mouseY, final float partialTicks) {
        ...
        FontManager.arial16.drawString(modeValue.getValue().getName(), (float) (this.position.x + FontManager.arial16.getStringWidth(prefix) + 2), (float) this.position.y, this.getStandardClickGUI().fontDarkColor.hashCode());
    }
