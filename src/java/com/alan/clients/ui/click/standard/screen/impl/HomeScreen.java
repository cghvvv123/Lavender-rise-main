...
//                positionOfLogo.x + 1.5f, positionOfLogo.y + 43, clickGUI.fontColor.hashCode());
        ...
        FontManager.arial20.drawString(text, positionOfSearch.x - FontManager.arial20.getStringWidth(text) / 2f, positionOfSearch.y, new Color(clickGUI.fontColor.getRed(), clickGUI.fontColor.getBlue(), clickGUI.fontColor.getGreen(), 70).hashCode());
    }
