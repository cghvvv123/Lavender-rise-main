package com.alan.clients.ui.cloudmusic;
...
import com.alan.clients.ui.cloudmusic.ui.TrackSlot;
import com.alan.clients.ui.cloudmusic.utils.CloudMusicAPI;
import com.alan.clients.ui.cloudmusic.utils.Lyric;
import com.alan.clients.ui.cloudmusic.utils.SpectrumUtil;
import com.alan.clients.ui.cloudmusic.utils.Track;
import com.alan.clients.util.FileManager;
        ...
        if (!mp3File.exists() && !flacFile.exists()) {
            ...
            loadingThread = new Thread(() -> {
                try {
                    ...
                    ChatUtil.display("缓存音乐时发生错误, 可能是因为该歌曲已被下架或需要VIP!");
                    if (mp3File.exists())
                        mp3File.delete();
                    if (flacFile.exists())
                        flacFile.delete();
