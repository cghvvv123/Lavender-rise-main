...
//	public ModuleSlot parent;
    ...
    public void draw(float x, float y) {
        ...
        FontManager.arial13.drawString(this.textString, this.x + 1.5f - this.offset, this.y + 6F, Color.GRAY.getRGB());

        if (this.isFocused) {
            float width = FontManager.arial13.getStringWidth(this.textString.substring(0, selectedChar)) + 4;
        ...
        if (this.isFocused) {
            ...
            switch (key) {
                ...
                case Keyboard.KEY_INSERT:
                    ...
                    this.selectedChar = this.textString.length();
                    width = FontManager.arial13.getStringWidth(this.textString.substring(0, this.selectedChar))
                            + 2;
                ...
                case Keyboard.KEY_BACK:
                    try {
                        ...
                        if (this.textString.length() != 0) {
                            ...
                            --this.selectedChar;
                            if (FontManager.arial13.getStringWidth(oldString) + 2 > 111F && this.offset > 0.0F) {
                                newTextWidth = FontManager.arial13.getStringWidth(this.textString) + 2;
                                oldTextWidth = FontManager.arial13.getStringWidth(oldString) + 2;
    ...
    public void charTyped(char c) {
        if (this.isFocused && ChatAllowedCharacters.isAllowedCharacter(c)) {
            ...
            if (this.selectedChar > this.textString.length()) {
                ...
                ++this.selectedChar;
                float width = FontManager.arial13
