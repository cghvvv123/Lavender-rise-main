...
public class QRLoginScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.arial16.drawString(text, res.getScaledWidth() / 2f - (FontManager.arial16.getStringWidth(text) / 2f), 30, 0xFFFFFFFF);
        FontManager.arial16.drawString(state, res.getScaledWidth() / 2f - (FontManager.arial16.getStringWidth(state.replaceAll("\247.", "")) / 2f), 50, 0xFFFFFFFF);

        if(this.loginProcessThread != null) {
            RenderUtil.drawImage2(new ResourceLocation("cloudMusicCache/qrcode"), res.getScaledWidth() / 2f - 64, 70, 128, 128, 1f);
        }
