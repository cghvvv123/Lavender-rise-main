...
public class TrackSlot {
    ...
    public void render(float a, float b, int mouseX, int mouseY) {
        ...
        FontManager.arial16.drawString(track.name, x + 2, y + 3, Color.BLACK.getRGB());
        FontManager.arial13.drawString(track.artists, x + 2, y + 12, Color.BLACK.getRGB());
        ...
        FontManager.micon15.drawString("J", x + 125.5f, y + 7f, Color.BLACK.getRGB());
