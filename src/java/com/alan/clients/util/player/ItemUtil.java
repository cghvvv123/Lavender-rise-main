...
public class ItemUtil {
    ...
    public boolean useful(final ItemStack stack) {
        ...
        if (item instanceof ItemBlock) {
            ...
            if (block instanceof BlockGlass || block instanceof BlockStainedGlass || (block.isFullBlock() && !(block instanceof BlockSlime || block instanceof BlockFalling))) {
                return true;
            }
        }
    ...
    public int getSlot(ItemStack targetStack) {
