...
public class Block {
    ...
    public boolean shouldSideBeRendered(final IBlockAccess worldIn, final BlockPos pos, final EnumFacing side) {
        ...
        if (xRay.isEnabled() && xRay.isWhitelisted(BlockUtil.getBlockAtPos(pos))) {
            if (xRay.bypass.getValue()) {
    ...
    public EnumWorldBlockLayer getBlockLayer() {
        XRay xRay = Client.INSTANCE.getModuleManager().get(XRay.class);
        return xRay.isEnabled() ? (xRay.isWhitelisted(blockState.getBlock()) ? EnumWorldBlockLayer.SOLID : EnumWorldBlockLayer.TRANSLUCENT) : EnumWorldBlockLayer.SOLID;
    ...
    public float getAmbientOcclusionLightValue() {
        XRay xRay = Client.INSTANCE.getModuleManager().get(XRay.class);
        return xRay.isEnabled() ? 1.0F : (this.isBlockNormalCube() ? 0.2F : 1.0F);
