...
public class GuiChat extends GuiScreen
{
     ...
     */
    RapeMasterFontManager font = FontManager.arial16;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawRect(2F, (float) (this.height - (14 * openingAnimation.getOutput())), this.width - 4, 12, Integer.MIN_VALUE);
