...
//        }
        ...
        if (this.recordPlayingUpFor > 0) {
            ...
            if (l1 > 8) {
                ...
                this.getFontRenderer().drawString(this.recordPlaying, (double) -this.getFontRenderer().width(this.recordPlaying) / 2, -4, l + (l1 << 24 & -16777216));
                GlStateManager.disableBlend();
        ...
        if (scoreobjective1 != null && !Client.INSTANCE.getModuleManager().get(ScoreBoard.class).isEnabled())
        {
...
//        this.persistantChatGUI.drawChatLimitedFrameRate(this.updateCounter);
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            this.drawTexturedModalRect(i - 91 - 1 + Client.INSTANCE.getSlotSpoofHandler().getSpoofedSlot() * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            this.zLevel = f;
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        int i = this.getFontRenderer().width(objective.getDisplayName());

        for (Score score : collection)
        {
            ScorePlayerTeam scoreplayerteam = scoreboard.getPlayersTeam(score.getPlayerName());
            String s = ScorePlayerTeam.formatPlayerName(scoreplayerteam, score.getPlayerName()) + ": " + EnumChatFormatting.RED + score.getScorePoints();
            i = Math.max(i, this.getFontRenderer().width(s));
        }
        ...
        for (Score score1 : collection)
        {
            ...
            this.getFontRenderer().drawString(s2, l - this.getFontRenderer().width(s2), k, 553648127);
            ...
            if (j == collection.size())
            {
                ...
                this.getFontRenderer().drawString(s3, l1 + i / 2 - this.getFontRenderer().width(s3) / 2, k - this.getFontRenderer().FONT_HEIGHT, 553648127);
            }
        }
    }
