...
import com.alan.clients.ui.jelloparticle.ParticleEngine;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback, InstanceAccess {
    ...
    public void drawWorldBackground(final int tint) {
        if (this.mc.theWorld != null) {
            ...
            FontManager.arial30.drawStringWithShadow(Client.NAME,width-FontManager.arial30.getStringWidth(Client.NAME)-FontManager.arial15.getStringWidth(Client.VERSION) - 5,height-FontManager.arial30.getStringHeight2(Client.NAME),new Color(255,255,255,200).getRGB());
            FontManager.arial15.drawStringWithShadow(Client.VERSION,width-FontManager.arial15.getStringWidth(Client.VERSION) - 3,height-FontManager.arial30.getStringHeight2(Client.VERSION) / 2f - 2,new Color(255,255,255,200).getRGB());
        } else {
