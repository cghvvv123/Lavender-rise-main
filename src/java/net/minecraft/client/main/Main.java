...
//        PacketBuffer buf = new PacketBuffer(Unpooled.wrappedBuffer(new byte[]{0, 0, 0, 12, 8, 72, 85, 68, 80, 114, 111, 120, 121, 8, 72, 85, 68, 80, 114, 111, 120, 121, 13, 80, 97, 114, 116, 58, 78, 111, 116, 69, 120, 105, 115, 116, 0, 0, 0, 1, 0, 0, 1, 2, 0, 0, 0, -97}));
//        buf.readInt();
//
//
//        System.out.println(buf.readStringFromBuffer(9999));
//        System.out.println(buf.readStringFromBuffer(9999));
//        System.out.println(buf.readStringFromBuffer(9999));
...
//
//
//        System.out.println(buf.readVarIntFromBuffer());
//        System.out.println(buf.readInt());
//        System.out.println(buf.readStringFromBuffer(32767));
//        System.out.println(buf.readStringFromBuffer(32767));
//        System.out.println(buf.readVarIntFromBuffer());
//
...
//        System.out.println(buf.readStringFromBuffer(20));
        ...
        final OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Lavender12312323");
        ...
        final File file2 = optionset.has(optionspec3) ? optionset.valueOf(optionspec3) : new File(file1, "assets/minecraft/");
