...
public abstract class ChunkProviderClient implements IChunkProvider {
    ...
    public abstract Chunk getLoadedChunk(long position);
    ...
    public boolean isChunkGeneratedAt(int p_191062_1_, int p_191062_2_) {
        return this.chunkMapping.containsItem(ChunkPos.asLong(p_191062_1_, p_191062_2_));
    }
}
