...
public class EntityRenderer implements IResourceManagerReloadListener, InstanceAccess {
    ...
    private void updateFovModifierHand() {
        ...
        // Client
        if (Client.INSTANCE.getModuleManager().get(Scaffold.class).isEnabled() && Client.INSTANCE.getModuleManager().get(Scaffold.class).enablefov.getValue()) {
            this.fovModifierHand = Client.INSTANCE.getModuleManager().get(Scaffold.class).fov.getValue().floatValue();
        } else if (Client.INSTANCE.getModuleManager().get(NoFov.class).isEnabled()) {
            this.fovModifierHand = Client.INSTANCE.getModuleManager().get(NoFov.class).fov.getValue().floatValue();
        }
    }
    ...
    public void updateCameraAndRender(final float partialTicks, final long p_181560_2_) {
            ...
            if (this.mc.theWorld != null) {
                ...
                if ((!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null)) {
                    ...
                    if(!BackCamera.silentRender){
                        ...
                        BackCamera.INSTANCE.onRender2D.call(new Render2DEvent(mc.scaledResolution, partialTicks));
                    }
