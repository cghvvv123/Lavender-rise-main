    ...
    public void renderOverlays(final float partialTicks) {
        ...
        if (this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
            ...
            if (iblockstate.getBlock().getRenderType() != -1) {
                ...
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderBlockOverlay, (Object) this.mc.thePlayer, Optional.of(Optional.of(Optional.of(Optional.of(Optional.ofNullable(Float.valueOf(partialTicks)))))), object, Optional.of(iblockstate), Optional.of(blockpos))) {
        ...
        if (!this.mc.thePlayer.isSpectator()) {
            ...
            if (!Client.INSTANCE.getModuleManager().get(NoCameraClip.class).NoFire.getValue()) {
        ...
        if (this.itemToRender != null && itemstack != null) {
            if (!this.itemToRender.getIsItemStackEqual(itemstack)) {
                if (Reflector.ForgeItem_shouldCauseReequipAnimation.exists()) {
                    boolean flag1 = Reflector.callBoolean(this.itemToRender.getItem(), Reflector.ForgeItem_shouldCauseReequipAnimation, new Object[]{this.itemToRender, itemstack, Boolean.valueOf(this.equippedItemSlot != Client.INSTANCE.getSlotSpoofHandler().getSpoofedSlot())});

                    if (!flag1) {
                        this.itemToRender = itemstack;
                        this.equippedItemSlot = Client.INSTANCE.getSlotSpoofHandler().getSpoofedSlot();
                        return;
                    }
                }
