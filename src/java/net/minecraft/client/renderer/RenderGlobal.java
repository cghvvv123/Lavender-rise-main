    ...
    public void renderEntities(final Entity renderViewEntity, final ICamera camera, final float partialTicks) {
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            for (final Object e : this.renderInfosTileEntities) {
                final ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation1 = (ContainerLocalRenderInformation) e;
...
//            }
        ...
        if (!flag && this.displayListEntitiesDirty && !Shaders.isShadowPass) {
            ...
            if (renderchunk != null && renderchunk.getPosition().getY() <= j) {
                boolean flag2 = false;
                final ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation4 = new ContainerLocalRenderInformation(renderchunk, null, 0);
