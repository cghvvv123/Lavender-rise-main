...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    private void func_181565_a(final WorldRenderer worldRenderer, final int x, final int y, final int width, final int height, final int p_181565_6_, final int p_181565_7_, final int p_181565_8_, final int p_181565_9_) {
        ...
        worldRenderer.pos(x + 0, y + 0, 0.0D).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        worldRenderer.pos(x + 0, y + height, 0.0D).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        worldRenderer.pos(x + width, y + height, 0.0D).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        worldRenderer.pos(x + width, y + 0, 0.0D).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
