...
public class EntityTracker {
    ...
    public void updateTrackedEntities() {
        ...
        synchronized (trackedEntities) {
            try {
                for (final EntityTrackerEntry entitytrackerentry : trackedEntities) {
                ...
                for (int i = 0; i < list.size(); ++i) {
                    ...
                    for (final EntityTrackerEntry entitytrackerentry1 : trackedEntities) {
                ...
                // 处理异常
                logger.error("Exception occurred while updating tracked entities", exception);
            }
        }
    }
