...
public class Config {
    ...
    public static IResourcePack[] getResourcePacks() {
        ...
        for (final Object e : list) {
            final Entry resourcepackrepository$entry = (Entry) e;
    ...
    public static IResourcePack getDefiningResourcePack(final ResourceLocation p_getDefiningResourcePack_0_) {
        ...
        if (iresourcepack != null && iresourcepack.resourceExists(p_getDefiningResourcePack_0_)) {
            ...
            final List<Entry> list = resourcepackrepository.repositoryEntries;

            for (int i = list.size() - 1; i >= 0; --i) {
                final Entry resourcepackrepository$entry = list.get(i);
    ...
    public static void checkDisplaySettings() {
        ...
        if (i > 0) {
            ...
            if (!Minecraft.isRunningOnMac && getDefaultResourcePack() != null) {
                ...
                try {
                    inputstream = getDefaultResourcePack().getInputStreamAssets(new ResourceLocation("lavender/icons/icon16x.png"));
                    inputstream1 = getDefaultResourcePack().getInputStreamAssets(new ResourceLocation("lavender/icons/icon32x.png"));
